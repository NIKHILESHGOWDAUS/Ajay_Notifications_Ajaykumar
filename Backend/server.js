...
const corsOptions = {
    origin: [
        'http://127.0.0.1:5503',
        'http://localhost:5503',
        'http://3.82.93.13:3636',
        'http://3.82.93.13:8650', // HR Notification Portal
        'http://3.82.93.13:8651', // Employee Notification Portal
        'http://localhost:8053',
        'http://localhost:8054',
    ],
...
async function startServer() {
    try {
        ...
        app.listen(port, host, () => {
            console.log(`Server running on http://${host}:${port} (accessible at http://3.82.93.13:${port})`);
        });
    } catch (error) {
